...
<head>
    ...
    <script async>
        ...
        $(window).scroll(function() {
            ...
            if ($(window).scrollTop() > ($('.deleteaccountBox').offset().top - 42)) {
                $('.active').removeClass('active');
                $('.deleteaccount').addClass('active');
                
            } else if ($(window).scrollTop() > ($('.passwordresetBox').offset().top - 42)) {
                $('.active').removeClass('active');
                $('.passwordreset').addClass('active');
                
            } else if ($(window).scrollTop() > ($('.messagesBox').offset().top - 42)) {
                $('.active').removeClass('active');
                $('.messages').addClass('active');
                
            } else if ($(window).scrollTop() > ($('.privacyBox').offset().top - 42)) {
                $('.active').removeClass('active');

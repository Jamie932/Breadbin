<?php 
    ...
    $ingredArray = json_decode($_POST['ingredients']);
        ...
        if (empty($_POST['title'])) {
            ...
            $query_params = array(':userid' => $_SESSION['user']['id'], ':text' => $_POST['title'], ':serves' => $_POST['serves'],':ingreds' => $_POST['ingredients'], ':instruc' => $_POST['instructions'], ':prep' => $prepTimeArray, ':cook' => $_POST['cookTime']); 

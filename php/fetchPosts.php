        ...
        foreach ($posts as $row) {
            ...
            if ($row['type'] == "imagetext") {
                ...
                echo '<div id="leftUserImg">';
                    ...
                    echo '</a>';
                echo '</div>';
                echo $row['favourite'] ? '<div id="heart"><i class="fa fa-heart" style="cursor: none;"></i></div><div class="contentPostImage ' . $class . ' favouriteImg">' : '<div class="contentPostImage ' . $class . '">';
                ...
                echo '<div id="leftUserImg">';
                    ...
                    echo '</a>';
                echo '</div>';
                echo $row['favourite'] ? '<div id="heart"><i class="fa fa-heart" style="cursor: none;"></i></div><div class="contentPostText favouriteText">' : '<div class="contentPostText">';
                ...
                echo '<div id="leftUserImg">';
                    ...
                    echo '</a>';
                echo '</div>';
                echo $row['favourite'] ? '<div id="heart"><i class="fa fa-heart" style="cursor: none;"></i></div><div class="contentPostImage imgNoPadding favouriteImg">' : '<div class="contentPostVideo imgNoPadding">';

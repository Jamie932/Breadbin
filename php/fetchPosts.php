        ...
        foreach ($posts as $row) {
            ...
            echo '<div id="post">';
                ...
                echo '<div id="leftUserImg">';
                    ...
                    echo file_exists('img/avatars/' . $row['userid'] . '/avatar.jpg') ? '<img src="img/avatars/' . $row['userid'] . '/avatar.jpg" height="50px" width="50px" style="border-radius:50%;">' : '<img src="img/profile2.png" height="50px" style="border-radius:50%;">';
                    echo '</a>';
                echo '</div>';

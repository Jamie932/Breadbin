<?php
	...
	if (basename($_SERVER['PHP_SELF']) != "showPost.php") {
    ...
    if (!$posts && $following == 0) {
        echo '<div id="post">';
				...
				echo '<div id="contentPost">';
				   echo '<div class="contentPostText">';
						echo '<p style="margin: 0;"><center>You don\'t follow any toasters!</p><a id="showMeToasters">Show me how to!</a>';
        ...
        echo '<div id="post">';
				...
				echo '<div id="contentPost">';
				   echo '<div class="contentPostText">';
						echo '<p style="margin: 0;"><center>You and your toasters haven\'t posted anything!</p><a id="showMePosts">Show me how to!</a>';
                        echo '<div class="meter orange nostripes">
